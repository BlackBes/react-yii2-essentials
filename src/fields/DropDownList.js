        ...
        return (
            <div className={'form-group field-' + this.props.model + "-" + this.props.name + ' ' + this.props.class}>
                ...
                <select   id={this.props.model + "-" + this.props.name}
                          className={'form-control '+(this.state.validation !== ''? (this.state.validation === true) ? 'is-valid' : 'is-invalid' : '')}
                          name={this.props.model.charAt(0).toUpperCase() + this.props.model.slice(1) + "[" + this.props.name + ']'}
